...
export const Cell = ({ value, status }: Props) => {
  const classes = classnames(
    'flex items-center justify-center h-full w-full rounded-sm uppercase text-center text-4xl text-dynamic font-bold flex justify-center items-center border',
    {
